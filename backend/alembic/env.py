...
def alembic_include_object(object, name, type_, reflected, compare_to):
    ...
    # "oidc_states" reste liste ici uniquement pour eviter qu'Alembic ne genere
    # une migration de suppression : le modele OIDC a ete retire du code, mais la
    # table peut encore exister dans des bases deja deployees.
