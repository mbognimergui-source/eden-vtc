...
async def generate_video(request: GenVideoRequest, current_user: UserResponse = Depends(get_current_user)):
    """
...
async def generate_audio(request: GenAudioRequest, current_user: UserResponse = Depends(get_current_user)):
    """
...
async def transcribe_audio(request: TranscribeAudioRequest, current_user: UserResponse = Depends(get_current_user)):
    """
...
async def analyze_pdf(request: AnalyzePdfRequest, current_user: UserResponse = Depends(get_current_user)):
    """
